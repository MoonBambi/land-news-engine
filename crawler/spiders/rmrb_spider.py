...
from config.rmrb_settings import RMRB_COOKIES, RMRB_HEADERS, RMRB_SEARCH_URL, RMRB_KEYWORDS
from config.logger import setup_logger

log_dir = os.path.join(project_root, "logs")
logger = setup_logger("rmrb_spider", os.path.join(log_dir, "rmrb_spider.log"))
